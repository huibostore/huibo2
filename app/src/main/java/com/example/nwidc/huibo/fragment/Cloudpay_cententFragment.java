...
/**
 * Created by hello on 2017/6/1
 */

public class Cloudpay_cententFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewContent = inflater.inflate(R.layout.fragment_cloudpay, container, false);
...
//        textView.setText(this.mTitle);
        ...
        //设置图片加载器
        banner.setImageLoader(new Cloudpay_cententFragment.GlideImageLoaders());
