...
import com.example.nwidc.huibo.Adapter.GridAdapter;
import com.example.nwidc.huibo.Meizi;
import com.example.nwidc.huibo.MyOkhttp;
import com.example.nwidc.huibo.R;
import com.example.nwidc.huibo.SnackbarUtil;
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(!TextUtils.isEmpty(result)){
                ...
                if(mAdapter==null){
                    recyclerview.setAdapter(mAdapter = new GridAdapter(BookingActivity.this,meizis));
