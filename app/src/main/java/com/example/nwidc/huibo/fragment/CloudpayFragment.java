...
public class CloudpayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        view =  inflater.inflate(R.layout.activity_yungou, null);
    ...
    public void initData() {
        //获取标签数据
        String[] titles = new String[]{"推荐@dream@0", "精选@dream@1", "热卖@dream@2", "易购@dream@3","淘宝@dream@3",};
        fragments= new ArrayList<Fragment>();
        fragments.add(new Cloudpay_cententFragment());
