...
public class PullUpToLoadMore extends ViewGroup {
    ...
    ObservableScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (ObservableScrollView) getChildAt(0);
                bottomScrollView = (ObservableScrollView) getChildAt(1);
                topScrollView.setScrollListener(new ObservableScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new ObservableScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
