...
public class Wholesale_contentFragmeng extends Fragment {

    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){

        View view = inflater.inflate(R.layout.fragment_wholesale,null);
        ...
        //设置图片加载器
        banner.setImageLoader(new Wholesale_contentFragmeng.GlideImageLoaders());
